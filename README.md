...
Preferences are stored in standard macOS app settings. History is stored only on
this Mac and is not encrypted (same idea as Windows clipboard history). Delete
an entry (`⌘⌫`) or clear history if you copy a password.
